...
public class TezosContractJSON {
    private final long start;
    private final long end;

    public static TezosContractJSON fromMarkers(Marker low, Marker high) {
        long start;
        long end;
        ...
        return new TezosContractJSON(start, end);
    }

    @JsonCreator
    public TezosContractJSON(
